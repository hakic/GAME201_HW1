...
vec = ti.Vector(2, dt=ti.f32, shape=2 * max_num_particles)
k1 = ti.Vector(2, dt=ti.f32, shape=2 * max_num_particles)
k2 = ti.Vector(2, dt=ti.f32, shape=2 * max_num_particles)
k3 = ti.Vector(2, dt=ti.f32, shape=2 * max_num_particles)
k4 = ti.Vector(2, dt=ti.f32, shape=2 * max_num_particles)
...
linear_b = ti.var(dt=ti.f32, shape=2 * max_num_particles)
linear_r = ti.var(dt=ti.f32, shape=2 * max_num_particles)
linear_X = ti.var(dt=ti.f32, shape=2 * max_num_particles)
linear_temp_X = ti.var(dt=ti.f32, shape=2 * max_num_particles)
